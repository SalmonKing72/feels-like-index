...
Calculator.prototype.currentTempFahr = function getCurrentTemperatureFahrenheit(obj) {
    "use strict";
    return Math.ceil((obj.main.temp - 273.15) * 1.80 + 32) || null;
};

Calculator.prototype.currentTempCels = function getCurrentTemperatureCelsius(obj) {
    "use strict";
    return Math.ceil((obj.main.temp - 273.15)) || null;
};

Calculator.prototype.currentWeather = function getCurrentWeather(obj) {
    "use strict";
...
Calculator.prototype.calculateWindChill = function calculateWindChill(obj) {
    "use strict";
...
Calculator.prototype.calculateHeatIndex = function calculateHeatIndex(obj) {
    "use strict";
    if (obj !== null && typeof obj !== "undefined") {
